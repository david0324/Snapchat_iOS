...
- (void)setUpACPScrollMenu:(NSArray *)menuItems {
	...
	// Setting ScrollView
	_scrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(0, 0, self.superview.frame.size.width, self.frame.size.height)];
    ...
    NSLog(@"%f %f",kScrollViewFirstWidth * 2 + (kScrollViewItemMarginWidth * (menuItemsArrayCount - 1)) + menuItem.frame.size.width * menuItemsArrayCount,self.frame.size.height);
