...
NSString *const kGPUImageStretchDistortionFragmentShaderString1 = SHADER_STRING
(
 ...
 void main()
 {
     ...
     normCoord = 0.5 * normCoord + 0.5 * smoothstep(0.2, 0.5, normCoord) * normCoord;
...
@implementation GPUImageStretchDistortionFilter1
...
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kGPUImageStretchDistortionFragmentShaderString1]))
    {
		return nil;
    }
    ...
    self.center = CGPointMake(0.5, 0.65);
