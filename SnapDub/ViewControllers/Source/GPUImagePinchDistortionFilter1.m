...
NSString *const kGPUImagePinchDistortionFragmentShaderString1 = SHADER_STRING
(
...
@interface GPUImagePinchDistortionFilter1 ()
...
@implementation GPUImagePinchDistortionFilter1
...
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kGPUImagePinchDistortionFragmentShaderString1]))
    {
		return nil;
    }
