...
NSString *const kGPUImageBulgeDistortionFragmentShaderString2 = SHADER_STRING
(
...
@interface GPUImageBulgeDistortionFilter2 ()
...
@implementation GPUImageBulgeDistortionFilter2
...
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kGPUImageBulgeDistortionFragmentShaderString2]))
    {
		return nil;
    }
    ...
    self.radius = 0.36;
    self.scale = 0.7;
    self.center = CGPointMake(0.5, 0.35);
