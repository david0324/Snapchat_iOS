...
NSString *const kGPUImageSwirlFragmentShaderString1 = SHADER_STRING
(
...
@implementation GPUImageSwirlFilter1
...
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kGPUImageSwirlFragmentShaderString1]))
    {
		return nil;
    }
    ...
    self.radius = 0.3;
    self.angle = 0.3;
    self.center = CGPointMake(0.7, 0.5);
