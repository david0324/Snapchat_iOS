...
NSString *const kGPUImageBulgeDistortionFragmentShaderString1 = SHADER_STRING
(
...
@interface GPUImageBulgeDistortionFilter1 ()
...
@implementation GPUImageBulgeDistortionFilter1
...
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kGPUImageBulgeDistortionFragmentShaderString1]))
    {
		return nil;
    }
    ...
    self.radius = 0.25;
    self.scale = 0.6;
    self.center = CGPointMake(0.7, 0.35);
