...
- (void)setupAnimationInLayer:(CALayer *)layer withSize:(CGSize)size tintColor:(UIColor *)tintColor {
   ...
   //     CABasicAnimation *transformAnimation = [CABasicAnimation animationWithKeyPath:@"transform"];
        ...
        transformAnimation.values = @[[NSValue valueWithCATransform3D:CATransform3DMakeScale(0.6f, 0.6f, 0.0f)],
                                      [NSValue valueWithCATransform3D:CATransform3DMakeScale(0.8f, 0.8f, 0.0f)],
                                      [NSValue valueWithCATransform3D:CATransform3DMakeScale(0.6f, 0.6f, 0.0f)]];
        
        
        /*
        transformAnimation.duration = 2.0f - i * 0.4f;
        transformAnimation.fromValue = [NSValue valueWithCATransform3D:CATransform3DMakeScale(0.7f, 0.7f, 0.0f)];
