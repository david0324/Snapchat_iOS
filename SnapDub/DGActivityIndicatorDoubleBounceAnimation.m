...
- (void)setupAnimationInLayer:(CALayer *)layer withSize:(CGSize)size tintColor:(UIColor *)tintColor {
    ...
    for (int i = 0; i < 1; i++) {
        ...
        transformAnimation.values = @[[NSValue valueWithCATransform3D:CATransform3DMakeScale(0.8f, 0.8f, 0.0f)],
                        [NSValue valueWithCATransform3D:CATransform3DMakeScale(1.0f, 1.0f, 0.0f)],
                        [NSValue valueWithCATransform3D:CATransform3DMakeScale(0.8f, 0.8f, 0.0f)]];
        ...
        transformAnimation.values = @[[NSValue valueWithCATransform3D:CATransform3DMakeScale(0.7f, 0.7f, 0.0f)],
                                      [NSValue valueWithCATransform3D:CATransform3DMakeScale(0.9f, 0.9f, 0.0f)],
                                      [NSValue valueWithCATransform3D:CATransform3DMakeScale(0.7f, 0.7f, 0.0f)]];
